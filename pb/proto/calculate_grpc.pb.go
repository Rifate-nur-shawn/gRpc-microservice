...
const (
	Calculate_Add_FullMethodName = "/pb.Calculate/Add"
)
...
func (c *calculateClient) Add(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponce, error) {
...
func (UnimplementedCalculateServer) Add(context.Context, *AddRequest) (*AddResponce, error) {
