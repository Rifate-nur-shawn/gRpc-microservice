...
const file_proto_calculate_proto_rawDesc = "" +
	"\n" +
	"\x15proto/calculate.proto\x12\x02pb\"(\n" +
	"\n" +
	"AddRequest\x12\f\n" +
	"\x01a\x18\x01 \x01(\x05R\x01a\x12\f\n" +
	"\x01b\x18\x02 \x01(\x05R\x01b\"\x1f\n" +
	"\vAddResponce\x12\x10\n" +
	"\x03sum\x18\x01 \x01(\x05R\x03sum23\n" +
	"\tCalculate\x12&\n" +
	"\x03Add\x12\x0e.pb.AddRequest\x1a\x0f.pb.AddResponceB2Z0github.com/rifate-nur-shawn/gRpc-microservice/pbb\x06proto3"
...
var file_proto_calculate_proto_goTypes = []any{
	...
	(*AddResponce)(nil), // 1: pb.AddResponce
}
var file_proto_calculate_proto_depIdxs = []int32{
	0, // 0: pb.Calculate.Add:input_type -> pb.AddRequest
	1, // 1: pb.Calculate.Add:output_type -> pb.AddResponce
