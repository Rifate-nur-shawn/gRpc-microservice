...
// The request message containing the user's name and a year
...
func (x *GreetRequest) GetInput() string {
	if x != nil {
		return x.Input
	}
	return ""
...
func (x *GreetRequest) GetYear() int32 {
	if x != nil {
		return x.Year
	}
	return 0
...
// The response message containing the greeting text and the year
...
func (x *GreetResponse) GetYear() int32 {
	if x != nil {
		return x.Year
	}
	return 0
...
const file_proto_greeter_proto_rawDesc = "" +
	"\n" +
	"\x13proto/greeter.proto\x12\x02pb\"8\n" +
	"\fGreetRequest\x12\x14\n" +
	...
	"\x04year\x18\x02 \x01(\x05R\x04year27\n" +
	"\aGreeter\x12,\n" +
	"\x05Greet\x12\x10.pb.GreetRequest\x1a\x11.pb.GreetResponseB2Z0github.com/rifate-nur-shawn/gRpc-microservice/pbb\x06proto3"
...
var file_proto_greeter_proto_depIdxs = []int32{
	...
	1, // 1: pb.Greeter.Greet:output_type -> pb.GreetResponse
