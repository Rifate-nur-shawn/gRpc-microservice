...
const file_proto_stream_stream_proto_rawDesc = "" +
	"\n" +
	"\x19proto/stream/stream.proto\x12\tcalculate\"(\n" +
	"\n" +
	"AddRequest\x12\f\n" +
	...
	"\x05value\x18\x01 \x01(\x05R\x05value2\x96\x01\n" +
	"\n" +
	"Calculator\x126\n" +
	"\x05Adder\x12\x15.calculate.AddRequest\x1a\x16.calculate.AddResponse\x12P\n" +
	"\x11GenarateFibonacci\x12\x1b.calculate.FibonacciRequest\x1a\x1c.calculate.FibonacciResponse0\x01B9Z7github.com/rifate-nur-shawn/gRpc-microservice/pb/streamb\x06proto3"
...
var file_proto_stream_stream_proto_depIdxs = []int32{
	...
	1, // 2: calculate.Calculator.Adder:output_type -> calculate.AddResponse
	3, // 3: calculate.Calculator.GenarateFibonacci:output_type -> calculate.FibonacciResponse
